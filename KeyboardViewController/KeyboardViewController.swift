...
class KeyboardViewController: UIInputViewController {
    ...
    override func viewDidLoad() {
        ...
        self.KeyboardVCHeightConstraint = NSLayoutConstraint(item: self.view as Any, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: keyboardHeight+containerViewHeight)
